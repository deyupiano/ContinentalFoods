...
public class CreateMeal : IRequest<OperationResult<Meal>>
{
    public Guid IdMeal { get; set; } = Guid.NewGuid();
    ...
    public string? StrIngredient26 { get; set; }
    public string? StrIngredient27 { get; set; }
    public string? StrIngredient28 { get; set; }
    public string? StrIngredient29 { get; set; }
    public string? StrIngredient30 { get; set; }
